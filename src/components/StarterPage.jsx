                            ...
                            <div className="formBox flex flex-col gap-10 md:gap-16">
                                ...
                                <div className="entryForm flex flex-col gap-5">
                                  ...
                                  hover:bg-yellow-200 lg:h-[43px]">
                                        ...
                                        <Link to="/guestlogin"><button className="guestFormBtn bg-[#1d9bf0] rounded-3xl font-semibold text-lg hover:bg-sky-700 w-[300px] py-2 outline-none border-none" onClick={guestVisitLogin}>Guest Visit</button></Link>
